# Vivado batch script to run the Basys3 UART command decoder simulation.
...
set sim_top        "tb_vga_uart_control"
...
set sim_files [list \
    [file join $project_root sim tb tb_vga_uart_control.vhd] \
]
