# Vivado batch script to run the Basys3 CDC bus handshake simulation.
...
set sim_top        "tb_cdc_bus_handshake"
...
set sim_files [list \
    [file join $project_root sim tb tb_cdc_bus_handshake.vhd] \
]
