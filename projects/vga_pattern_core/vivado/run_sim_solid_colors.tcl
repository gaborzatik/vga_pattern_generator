# Vivado batch script to run the solid-color pattern-generator simulation.
...
set sim_top        "tb_vga_pattern_generator_solid_colors"

set sim_files [list \
    [file join $project_root sim pkg vga_pattern_sim_pkg.vhd] \
    [file join $project_root sim tb tb_vga_pattern_generator_solid_colors.vhd] \
]
