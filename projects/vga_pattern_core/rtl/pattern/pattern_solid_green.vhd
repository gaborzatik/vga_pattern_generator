--==============================================================================
-- File        : pattern_solid_green.vhd
-- Project     : vga_pattern_core
-- Unit        : pattern_solid_green
--
-- Description :
--   Generates a green fill while the addressable pattern area is active.
--
-- Project role:
...
--
-- Review notes:
--   This block intentionally ignores pixel coordinates because solid green has
...
--==============================================================================
-- Entity: pattern_solid_green
--
-- Purpose:
--   Provides a video_on_i-qualified green RGB record using the common pattern
--   output type.
--
-- Interface groups:
...
--
-- Output semantics:
--   Green when video_on_i is high, black otherwise.
--==============================================================================
