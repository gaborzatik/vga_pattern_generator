# Vivado batch script to run the reset-oriented timing-generator simulation.
...
set sim_top        "tb_vga_timing_generator_reset"

set sim_files [list \
    [file join $project_root sim pkg vga_timing_sim_pkg.vhd] \
    [file join $project_root sim tb tb_vga_timing_generator_reset.vhd] \
]
